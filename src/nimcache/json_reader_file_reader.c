...
/* Command for C compiler:
   gcc -c  -w  -I/home/benjamin/utils/Nim/lib -o /home/benjamin/dev/nim/json-reader/src/nimcache/json_reader_file_reader.o /home/benjamin/dev/nim/json-reader/src/nimcache/json_reader_file_reader.c */
...
NIM_EXTERNC N_NOINLINE(void, file_readerInit000)(void);
NIM_EXTERNC N_NOINLINE(void, file_readerDatInit000)(void);
STRING_LITERAL(TMP900, "file was read!", 14);
STRING_LITERAL(TMP901, "please pass JSON file to read", 29);
...
NIM_EXTERNC N_NOINLINE(void, file_readerInit000)(void) {
	nimfr("file_reader", "file_reader.nim")
	nimln(3, "file_reader.nim");
	{
		NI LOC3;
		NimStringDesc* LOC6;
