...
/* Command for C compiler:
   gcc -c  -w  -I/home/benjamin/utils/Nim/lib -o /home/benjamin/dev/nim/json-reader/src/nimcache/stdlib_etcpriv.o /home/benjamin/dev/nim/json-reader/src/nimcache/stdlib_etcpriv.c */
...
static N_INLINE(NIM_BOOL, ismagicidentseparatorrune_102004)(NCSTRING cs, NI i) {
	...
	if (!(LOC2)) goto LA3;
	nimln(22, "etcpriv.nim");
	TMP150 = addInt(i, ((NI) 1));
	LOC2 = ((NU8)(cs[(NI)(TMP150)]) == (NU8)(128));
	LA3: ;
	LOC1 = LOC2;
	if (!(LOC1)) goto LA4;
	nimln(23, "etcpriv.nim");
	TMP151 = addInt(i, ((NI) 2));
	LOC1 = ((NU8)(cs[(NI)(TMP151)]) == (NU8)(147));
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
