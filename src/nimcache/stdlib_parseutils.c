...
/* Command for C compiler:
   gcc -c  -w  -I/home/benjamin/utils/Nim/lib -o /home/benjamin/dev/nim/json-reader/src/nimcache/stdlib_parseutils.o /home/benjamin/dev/nim/json-reader/src/nimcache/stdlib_parseutils.c */
...
N_NIMCALL(NI, rawparseint_93727)(NimStringDesc* s, NI64* b, NI start);
...
STRING_LITERAL(TMP652, "overflow", 8);
	...
	nimln(203, "parseutils.nim");
	{
		...
		(*b) = IL64(0);
		{
			...
			while (1) {
				...
				TMP290 = mulInt64((*b), IL64(10));
				if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
				TMP291 = subInt(((NI) (((NU8)(s->data[i])))), ((NI) 48));
				TMP292 = subInt64((NI64)(TMP290), ((NI64) ((NI)(TMP291))));
				(*b) = (NI64)(TMP292);
				nimln(207, "parseutils.nim");
				TMP293 = addInt(i, ((NI) 1));
				i = (NI)(TMP293);
				{
		...
		TMP295 = mulInt64((*b), sign);
		(*b) = (NI64)(TMP295);
		nimln(210, "parseutils.nim");
		TMP296 = subInt(i, start);
		result = (NI)(TMP296);
	}
	LA10: ;
	popFrame();
...
N_NIMCALL(NI, npuParseBiggestInt)(NimStringDesc* s, NI64* number, NI start) {
	...
	result = rawparseint_93727(s, (&res), start);
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	nimln(231, "parseutils.nim");
	{
		...
		e_93841 = (Overflowerror3640*) newObj((&NTI24269), sizeof(Overflowerror3640));
		(*e_93841).Sup.Sup.Sup.m_type = (&NTI3640);
		nimln(2508, "system.nim");
		LOC9 = 0;
		LOC9 = (*e_93841).Sup.Sup.message; (*e_93841).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP652));
		if (LOC9) nimGCunrefNoCycle(LOC9);
		nimln(233, "parseutils.nim");
		raiseException((Exception*)e_93841, "OverflowError");
	}
	goto LA1;
	LA7: ;
	{
